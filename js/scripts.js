...
switch (carrito) {
    case "1":
        ...
        alert("Tu saldo a pagar fianl es de $ " + encastre_con_dto_con_iva);
        break;
    case "2":
        ...
        alert("Tu saldo a pagar fianl es de $ " + munieca_con_dto_con_iva);
        break;
    case "3":
        ...
        alert("Tu saldo a pagar fianl es de $ " + auto_pp_con_dto_con_iva);
        break;
